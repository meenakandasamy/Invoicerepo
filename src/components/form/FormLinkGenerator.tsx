...
export function FormLinkGenerator({
    ...
    const { mutate, isPending, isError } = useMutation({
        ...
        onSuccess: (data) => {
            ...
            const url = `${origin}${baseUrl}/#/${formPath}?id=${encodedUserId}&ec=${encodedEncryptedData}`;
        ...
        <Dialog open={open} onOpenChange={handleOpenChange}>
            ...
            >
                <DialogHeader>
                    ...
                    <DialogDescription>
                        {isPending ? 'Generating link, please wait...' : dialogDescription}
                    </DialogDescription>
                </DialogHeader>

                {isError ? <div className="text-red-500">Error generating link try again later or contact support</div> : <div className="flex items-center gap-2 relative">
                    <div className="grid flex-1 gap-2">
                        ...
                        {isPending ? (
                            ...
                            <div className="relative">
                                <Input id="link" value={generatedLink} readOnly className="pr-10" />
                                <button
                                    type="button"
