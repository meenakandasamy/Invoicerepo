...
import VendorAdvanceForm from '@/components/advanceForm/vendorAdvanceForm'
import { decodeURIComponentSafe } from '@/utils/decode';
import { VendorServices } from '@/integrations/Services/vendorServices';

export const Route = createFileRoute('/vendor_expenditure/advanceForm')({
...
function RouteComponent() {
  ...
  return (
    <div>
      <VendorAdvanceForm userId={userId} hashingKey={hashingKey} isValidForm={result} />
    </div>
  )
}
